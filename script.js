...
async function fetchDiscordStatus(){
  try{
    ...
    if(!data || !data.data){ discordStatus.textContent='Discord status unavailable'; return; }
  ...
  }catch(e){ console.log('Failed to fetch Discord status',e); discordStatus.textContent='Discord status unavailable'; }
}
